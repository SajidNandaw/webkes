...
<head>
  ...
  <title>Login - RS Tirta Negara</title>
...
<body class="min-h-screen bg-gray-200 flex items-center justify-center">
  ...
  <div class="w-[900px] h-[560px] bg-white rounded-md shadow-md overflow-hidden flex relative">
    ...
    <aside class="w-[310px] h-full bg-gradient-to-b from-teal-500 to-teal-300 relative overflow-hidden">
      ...
      <div class="absolute top-0 left-0 bg-white w-[250px] h-[92px] rounded-r-[70px] shadow-sm flex items-center px-4 z-10">
      ...
      <!-- SEGITIGA KIRI TENGAH (lebih kecil) -->
      <div class="absolute top-[200px] left-0 w-0 h-0
            border-l-[0px] border-l-transparent
            border-r-[100px] border-r-transparent
            border-b-[140px] border-b-teal-200/60"></div>


      <!-- SEGITIGA KIRI BAWAH -->
      <div class="absolute -bottom-6 left-[-50px] w-0 h-0
                  border-l-[100px] border-l-transparent
                  border-r-[100px] border-r-transparent
                  border-t-[160px] border-t-teal-200/50 rotate-[18deg]"></div>
        ...
        <form action="{{ route('login') }}" method="POST" class="w-full space-y-5">
          ...
          <label class="block">
            <div class="flex items-center bg-gradient-to-r from-teal-100 to-teal-50 rounded-md px-3 py-3 shadow-sm">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5 text-gray-600 mr-2">
